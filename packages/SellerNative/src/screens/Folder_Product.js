    ...
    return (
        ...
        <View style={{ height: '100%', padding: 20,backgroundColor:"#f1f1f1" }}>
            <MenuProvider>
                ...
                <View style={{
                    backgroundColor: '#fff',
                    width: '100%', paddingVertical: 12, paddingHorizontal: 10, elevation: 1, borderRadius: 5,marginVertical:10
                }}>
...
const styles = StyleSheet.create({
    ...
    InnerViewMainImage: {
        backgroundColor: '#fff', height: 33, width: 35, justifyContent: 'center', alignItems: 'center', borderRadius: 5,position:'absolute',bottom:10,right:8
    },
    IconePencilMain: {
    ...
    CalInputFaltModal: {
        fontSize: 17, fontFamily: 'Lato-Regular', paddingHorizontal: 8,height:40
    },
    AddViewModal: {
        color: '#002733', fontSize: 17, fontFamily: 'Poppins-SemiBold',paddingVertical:10
    },
    grayViewContainer: {
