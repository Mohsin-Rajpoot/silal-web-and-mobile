          ...
          <Modal
            ...
            <View style={styles.ModalContainerPreview}>
              <TouchableOpacity
                ...
                <Entypo
                  name="cross"
                  style={{fontSize: 30, color: '#002733'}}
              ...
              <View
                ...
                <View
                  ...
                  <Octicons
                    name="pencil"
                    style={{fontSize: 20, color: '#4C6870'}}
                  />
                </View>
              </View>
              <View style={{marginHorizontal: 40}}>
                ...
                <View>
                  ...
                  <TextInput
                    placeholder="Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat
            ...
            renderHiddenItem={(data, rowMap) => (
              <View style={styles.rowBack}>
                <View
                  ...
                  <TouchableOpacity
                    style={[styles.BackButtons, {backgroundColor: '#0065FF'}]}>
