    ...
    return (
      <TouchableOpacity style={styles.single_order}>
        ...
        <View style={styles.accept_btn}>
          <Text style={styles.accept_btn_txt}>{t('slide_to_Accept')}</Text>
        </View>
      </TouchableOpacity>
    );
  };
    ...
    <View style={{height: '82%', width: '100%'}}>
      <View style={{flexDirection: 'row'}}>
        ...
        <View
          ...
          <Text style={styles.title}>{t('Accepted')}</Text>
          <FlatList
            keyExtractor={(item, index) => index.toString()}
            data={data}
        ...
        <View
          ...
          <View
            ...
            <View>
              <Text style={styles.onway}>{t('onWay')}</Text>
              <Text style={[styles.onway, {marginTop: 5}]}>
                4 {t('orders')}
              </Text>
            </View>
          </View>
