...
const render_order_further_detail=()=>{
    ...
    const render_all_oredrs=(index)=>{
      return(
          <>
        <TouchableOpacity onPress={()=>setModalVisible(true)} style={[styles.render_all_orders,{backgroundColor:show_order_detail_view==true && index==selected_index?'#E6F4F2':'white'}]}>
          ...
          <View style={[styles.render_all_order_single,{width:'13%'}]}>
              <View  style={{backgroundColor:'#FF8B00',borderRadius:5,alignSelf:'flex-start',height:23,width:60,alignItems:'center',justifyContent:'center'}}>
                <Text style={{color:'white',fontFamily:'Lato-Regular',fontSize:11}}>Pending</Text>
              </View>
          </View>
          {/* <View style={[styles.render_all_order_single,{width:'12%',}]}>
