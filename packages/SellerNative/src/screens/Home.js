        ...
        <View>
          ...
          <View style={styles.MainWhiteDiv}>
            ...
            <View style={styles.One}>
              <View style={styles.WhiteDive}>
                <View style={styles.ImgeViewBKG}>
                  <Image source={require('../Assets/Bellicon.png')} style={styles.CurrencyImage} />
                </View>
        ...
        {Reviews ?
          <View>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', marginVertical: 10 }}>
              <View style={{ width: "68%", backgroundColor: '#fff', elevation: 5, borderRadius: 5, }}>
                <View style={{
                ...
                <FlatList
                  ...
                  renderItem={({ item }) => (
                    <View>
                      ...
                      <View style={{ borderBottomWidth: 1, marginHorizontal: 20, marginVertical: 10, borderBottomColor: '#809399', opacity: 0.1 }} />
                    </View>
                  )}
                  keyExtractor={item => item.id}
                />
              ...
              <View style={{ width: "25%", backgroundColor: '#fff', elevation: 5, borderRadius: 5, height: "26.5%" }}>
                ...
                <View style={{ borderBottomWidth: 0.2, marginHorizontal: 20, marginVertical: 10, borderBottomColor: '#809399', opacity: 0.1 }} />
