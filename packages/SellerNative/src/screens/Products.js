...
const Products = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={{ width: '94%', alignSelf: 'center', flex: 1, backgroundColor: '#fff' }}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          <View style={{ justifyContent: 'space-between', flexDirection: 'row', backgroundColor: 'red', width: '100%', }}>
            <TouchableOpacity style={{ height: 150, width: 150, backgroundColor: 'yellow' }}>
              <Text>hhh</Text>
            </TouchableOpacity>
            <View>
              <Text>hhh</Text>
