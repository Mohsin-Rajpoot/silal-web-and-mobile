...
const SaveDraftModal = (props) => {
    ...
    return (
        <View style={{ justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%',  }}>
            <View style={{ height: 150, width: 300, borderRadius: 5, elevation: 5, backgroundColor: '#fff',justifyContent:'space-between',flexDirection:'row',paddingHorizontal:15,paddingVertical:5}} onPress={() => props.changeModalVisibilty(false)}>
               
                    <Text style={{ color: '#414342', fontSize: 17, fontFamily: 'Poppins-SemiBold' }}>Save as drafts?</Text>
                    <TouchableOpacity 
