...
const CurrentOrder = React.lazy(() =>
  import("../views/pages/order/CurrentOrders")
);
const OrderDetail = React.lazy(() =>
  import("../views/pages/order/OrderDetail")
);
...
const AwaitingAcceptance = React.lazy(() =>
  import("../views/pages/order/AwaitingAcceptance")
);
const AcceptedOrders = React.lazy(() =>
  import("../views/pages/order/AcceptedOrders")
);
const WaitingForPickup = React.lazy(() =>
  import("../views/pages/order/WaitingForPickup")
);
const Products = React.lazy(() =>
  import("../views/pages/products/components/Products")
);
const ProductDetail = React.lazy(() =>
  import("../views/pages/products/components/ProductDetail")
);
const CreateItem = React.lazy(() =>
  import("../views/pages/products/components/CreateItem")
);
...
const ContactUs = React.lazy(() =>
  import("../views/pages/contact-us/ContactUs")
);
...
const OpeningHours = React.lazy(() =>
  import("../views/pages/profile/OpeningHours")
);
const PaymentHistory = React.lazy(() =>
  import("../views/pages/profile/PaymentHistory")
);
const TransactionLedger = React.lazy(() =>
  import("../views/pages/profile/TransactionLedger")
);
const CreateNewItem = React.lazy(() =>
  import("../views/pages/listing/CreateItem")
);
...
const Otppage = React.lazy(() =>
  import("../views/pages/Login/Otppage/Otppage")
);
...
const routes = [
  ...
  {
    path: "/orders/archive-order",
    exact: true,
    name: "Archive Orders",
    component: ArchiveOrders,
  },
  {
    path: "/orders/awaiting-acceptance",
    exact: true,
  ...
  {
    path: "/orders/waiting-for-pickup",
    exact: true,
    name: "Waiting For Pickup Orders",
    component: WaitingForPickup,
  },
  {
