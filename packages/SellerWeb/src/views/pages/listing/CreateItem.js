        ...
        <Wrapper>
            ...
            <CardStyled>
                <div className="stepper-wrapper">
                    <div className={`stepper-item active ${step === 2 ? 'complete' : ''}`}>
                        ...
                        <Col lg={8}>
                            <CardStyled>
                                ...
                                <div className="between mr-30">
                                    <Label color="#00273380">Item name <span style={{ color: "#E42A2A" }}>*</span></Label>
                                ...
                                <Label color="#00273380">Category  <span style={{ color: "#E42A2A" }}>*</span></Label>
                                <div className="d-flex align-items-center">
                                    <SelectDiv
